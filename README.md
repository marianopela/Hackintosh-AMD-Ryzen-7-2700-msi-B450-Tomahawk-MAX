...
2. Copy the EFI folder you downloaded from this repository into the USB stick EFI partition if you created it in macOS or into the Root of the USB Stick if you created it in Windows. 
